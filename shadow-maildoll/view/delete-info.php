<div class="outwrapper">
    <h1 class='display-5 fw-bold text-center'><?php _e('Delete Data','sdmaildoll');?></h1>

    <div class="text-center">
        <a href="<?php echo admin_url('admin.php?page=contacts&action=default') ?>" class='btn btn-primary'><?php _e('Default','sdmaildoll');?></a>
        <a href="<?php echo admin_url('admin.php?page=contacts&action=new') ?>" class='btn btn-primary'><?php _e('Add new','sdmaildoll');?></a>
